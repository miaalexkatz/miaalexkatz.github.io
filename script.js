    ...
    classes: [
        {
            name: 'Yes',
            title: '“Yes” examples.',
            description: 'Add examples of what you want to trigger your “yes” state. This can be anything you want, like holding up your hand or an object.'
        },
        {
            name: 'No',
            title: '“No” examples.',
            description: 'Add examples of what you want to trigger your “no” state. For example, without your hand or object.'
        }
    ],
    onLoad: () => {
